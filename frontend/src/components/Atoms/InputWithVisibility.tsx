...
const InputWithVisibility = React.forwardRef<HTMLInputElement, inputPropsType>((props, ref) => {
    ...
    return (
        <div className={finalClassName}>
            <input className="bg-transparent outline-none w-full text-sm md:text-base" ref={ref} type="password" required={props.required} />
            {props.type === "password" &&
